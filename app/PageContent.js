...
function getPhotos() {
  ...
  try {
    ...
    return imageFiles.map((filename) => `/fotos/${filename}`);
...
export default function PageContent({ photos }) {
    ...
    <main className="bg-black text-white">
      ...
      <section className="py-8 px-6 text-center bg-black">
        ...
        <div className="flex flex-col items-center gap-y-8">
          ...
          <a
            href="#inscricao"
            className="inline-block bg-green-500 hover:bg-green-600 px-8 py-4 rounded-xl text-xl transition font-montserrat font-bold animate-pulse-cta"
          >
            Garantir minha vaga!
          </a>
        </div>
      ...
      <section className="py-12 px-6 bg-gray-900 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-8">
          <div className="bg-black bg-opacity-60 border border-green-500 rounded-lg p-4 text-white min-w-[180px] flex items-center gap-2 justify-center">
          ...
          <div className="bg-black bg-opacity-60 border border-green-500 rounded-lg p-4 text-white min-w-[180px] flex items-center gap-2 justify-center">
            <FontAwesomeIcon icon={faCalendarAlt} className="w-5 h-5" /> 07 e 08/11/25
          </div>
        </div>
        {/* DESTAQUE ADICIONADO AQUI */}
        <div className="mt-12 max-w-3xl mx-auto">
          <h3 className="text-2xl md:text-3xl font-bold text-white font-biorhyme">
            <span className="text-green-500">+ de 20 horas de Imersão Presencial Intensiva</span><br />
            Das 08h às 20h
          </h3>
          <p className="mt-4 text-lg text-gray-300 font-chivo">
            Aproveite dois dias inteiros de conteúdo transformador para sua carreira.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-6 bg-gray-900">
        <h2 className="text-3xl md:text-4xl font-bold text-green-500 mb-12 text-center font-biorhyme">
            ...
            <div className="p-8 flex flex-col justify-center md:w-2/3 text-left space-y-5">
              <div>
                <div className="flex items-center space-x-3 mb-2">
                  <h3 className="text-3xl font-bold font-biorhyme text-green-500">
                    Daniel Reis
                  </h3>
                  <a href="https://www.instagram.com/danielreisaugusto" target="_blank" rel="noopener noreferrer" className="text-green-500 hover:text-green-600 text-2xl">
            ...
            <div className="p-8 flex flex-col justify-center md:w-2/3 text-left space-y-5">
              <div>
                <div className="flex items-center space-x-3 mb-2">
                  ...
                  <a href="https://www.instagram.com/eusouhugoalmeida" target="_blank" rel="noopener noreferrer" className="text-green-500 hover:text-green-600 text-2xl">
                    <FontAwesomeIcon icon={faInstagram} />
                  </a>
                </div>
                {/* FOCO NO RESULTADO (Hook Inicial) */}
      ...
      <section ref={formRef} id="inscricao" className="py-14 px-6 bg-black text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-green-500 mb-8 font-biorhyme">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full bg-green-500 hover:bg-green-600 py-4 rounded-lg text-xl transition font-montserrat font-bold animate-pulse-cta"
          >
            Reservar Minha Vaga
          </button>
          ...
          <p className="text-sm text-gray-400 pt-2">
            Após preencher, você será direcionado para o WhatsApp.
          </p>
        </form>
      ...
      {!isFormVisible && (
        <div className="fixed bottom-0 left-0 w-full bg-black bg-opacity-80 backdrop-blur-sm p-4 z-50 md:hidden">
          <a
            href="#inscricao"
            className="w-full text-center inline-block bg-green-500 hover:bg-green-600 px-6 py-3 rounded-xl text-lg transition font-montserrat font-bold text-white shadow-lg animate-pulse-cta"
          >
      ...
      <footer className="bg-gray-900 py-6 text-center text-gray-400 font-montserrat space-y-2">
        <p>© 2025 Mentoria HPI. Todos os direitos reservados.</p>
        <p className="text-sm">
          Desenvolvido por{' '}
          <a
